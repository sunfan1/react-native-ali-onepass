...
public class RNAliOnepassModule extends ReactContextBaseJavaModule implements TokenResultListener {
  ...
  public void setUIConfig(final ReadableMap config, final Promise promise) {
    ...
    setPrivacyAlertUI(builder, config);
  ...
  private void setPrivacyUI(AuthUIConfig.Builder builder, ReadableMap config) {
    if (config.hasKey(methodName2KeyName("setAppPrivacyOneName"))
        && config.hasKey(methodName2KeyName("setAppPrivacyOneUrl"))) {
      builder.setAppPrivacyOne(config.getString(methodName2KeyName("setAppPrivacyOneName")),
          config.getString(methodName2KeyName("setAppPrivacyOneUrl")));
    }
    if (config.hasKey(methodName2KeyName("setAppPrivacyTwoName"))
        && config.hasKey(methodName2KeyName("setAppPrivacyTwoUrl"))) {
      builder.setAppPrivacyTwo(config.getString(methodName2KeyName("setAppPrivacyTwoName")),
          config.getString(methodName2KeyName("setAppPrivacyTwoUrl")));
    }
    if (config.hasKey(methodName2KeyName("setAppPrivacyThreeName"))
        && config.hasKey(methodName2KeyName("setAppPrivacyThreeUrl"))) {
      builder.setAppPrivacyThree(config.getString(methodName2KeyName("setAppPrivacyThreeName")),
          config.getString(methodName2KeyName("setAppPrivacyThreeUrl")));
    }
    ...
    if (config.hasKey(methodName2KeyName("setAppPrivacyBaseColor"))
        && config.hasKey(methodName2KeyName("setAppPrivacyColor"))) {
      builder.setAppPrivacyColor(Color.parseColor(config.getString(methodName2KeyName("setAppPrivacyBaseColor"))),
          Color.parseColor(config.getString(methodName2KeyName("setAppPrivacyColor"))));
    }
   ...
   * @param config
   */
  private void setPrivacyAlertUI(AuthUIConfig.Builder builder, ReadableMap config) {
    if (config.hasKey("privacyAlertIsNeedShow")) {
      builder.setPrivacyAlertIsNeedShow(config.getBoolean("privacyAlertIsNeedShow"));
    }
    if (config.hasKey("privacyAlertIsNeedAutoLogin")) {
      builder.setPrivacyAlertIsNeedAutoLogin(config.getBoolean("privacyAlertIsNeedAutoLogin"));
    }
    if (config.hasKey("privacyAlertMaskIsNeedShow")) {
      builder.setPrivacyAlertMaskIsNeedShow(config.getBoolean("privacyAlertMaskIsNeedShow"));
    }
    if (config.hasKey("privacyAlertMaskAlpha")) {
      builder.setPrivacyAlertMaskAlpha(config.getInt("privacyAlertMaskAlpha"));
    }
    if (config.hasKey("privacyAlertAlpha")) {
      builder.setPrivacyAlertAlpha(config.getInt("privacyAlertAlpha"));
    }
    if (config.hasKey("privacyAlertBackgroundColor")) {
      builder.setPrivacyAlertBackgroundColor(Color.parseColor(config.getString("privacyAlertBackgroundColor")));
    }
    if (config.hasKey("privacyAlertEntryAnimation")) {
      builder.setPrivacyAlertEntryAnimation(config.getString("privacyAlertEntryAnimation"));
    }
    if (config.hasKey("privacyAlertExitAnimation")) {
      builder.setPrivacyAlertExitAnimation(config.getString("privacyAlertExitAnimation"));
    }
    if (config.hasKey("privacyAlertCornerRadiusArray")) {
      ReadableArray arr1 = config.getArray("privacyAlertCornerRadiusArray");
      builder.setPrivacyAlertCornerRadiusArray(new int[] {arr1.getInt(0),arr1.getInt(1),arr1.getInt(2),arr1.getInt(3)});
    }
    if (config.hasKey("privacyAlertAlignment")) {
      builder.setPrivacyAlertAlignment(config.getInt("privacyAlertAlignment"));
    }
    if (config.hasKey("privacyAlertWidth")) {
      builder.setPrivacyAlertWidth(config.getInt("privacyAlertWidth"));
    }
    if (config.hasKey("privacyAlertHeight")) {
      builder.setPrivacyAlertHeight(config.getInt("privacyAlertHeight"));
    }
    if (config.hasKey("privacyAlertOffsetX")) {
      builder.setPrivacyAlertOffsetX(config.getInt("privacyAlertOffsetX"));
    }
    if (config.hasKey("privacyAlertOffsetY")) {
      builder.setPrivacyAlertOffsetY(config.getInt("privacyAlertOffsetY"));
    }
    if (config.hasKey("privacyAlertTitleBackgroundColor")) {
      builder
          .setPrivacyAlertTitleBackgroundColor(Color.parseColor(config.getString("privacyAlertTitleBackgroundColor")));
    }
    if (config.hasKey("privacyAlertTitleAlignment")) {
      builder.setPrivacyAlertTitleAlignment(config.getInt("privacyAlertTitleAlignment"));
    }
    if (config.hasKey("privacyAlertTitleOffsetX")) {
      builder.setPrivacyAlertTitleOffsetX(config.getInt("privacyAlertTitleOffsetX"));
    }
    if (config.hasKey("privacyAlertTitleOffsetY")) {
      builder.setPrivacyAlertTitleOffsetY(config.getInt("privacyAlertTitleOffsetY"));
    }
    if (config.hasKey("privacyAlertTitleTextSize")) {
      builder.setPrivacyAlertTitleTextSize(config.getInt("privacyAlertTitleTextSize"));
    }
    if (config.hasKey("privacyAlertTitleColor")) {
      builder.setPrivacyAlertTitleColor(Color.parseColor(config.getString("privacyAlertTitleColor")));
    }
    if (config.hasKey("privacyAlertContentBackgroundColor")) {
      builder.setPrivacyAlertContentBackgroundColor(
              Color.parseColor(config.getString("privacyAlertContentBackgroundColor")));
    }
    if (config.hasKey("privacyAlertContentTextSize")) {
      builder.setPrivacyAlertContentTextSize(config.getInt("privacyAlertContentTextSize"));
    }
    if (config.hasKey("privacyAlertContentAlignment")) {
      builder.setPrivacyAlertContentAlignment(config.getInt("privacyAlertContentAlignment"));
    }
    if (config.hasKey("privacyAlertContentColor")) {
      builder.setPrivacyAlertContentColor(Color.parseColor(config.getString("privacyAlertContentColor")));
    }
    if (config.hasKey("privacyAlertContentBaseColor")) {
      builder.setPrivacyAlertContentBaseColor(Color.parseColor(config.getString("privacyAlertContentBaseColor")));
    }
    if (config.hasKey("privacyAlertContentHorizontalMargin")) {
      builder.setPrivacyAlertContentHorizontalMargin(
          config.getInt("privacyAlertContentHorizontalMargin"));
    }
    if (config.hasKey("privacyAlertContentVerticalMargin")) {
      builder
          .setPrivacyAlertContentVerticalMargin(config.getInt("privacyAlertContentVerticalMargin"));
    }
    if (config.hasKey("privacyAlertBtnBackgroundImgPath")) {
      builder.setPrivacyAlertBtnBackgroundImgPath(
          config.getString("privacyAlertBtnBackgroundImgPath"));
    }
    if (config.hasKey("privacyAlertBtnBackgroundImgDrawable")) {
      builder.setPrivacyAlertBtnBackgroundImgDrawable(
          Drawable.createFromPath(config.getString("privacyAlertBtnBackgroundImgDrawable")));
    }
    if (config.hasKey("privacyAlertBtnTextColor")) {
      builder.setPrivacyAlertBtnTextColor(Color.parseColor(config.getString("privacyAlertBtnTextColor")));
    }
    if (config.hasKey("privacyAlertBtnTextColorPath")) {
      builder.setPrivacyAlertBtnTextColorPath(config.getString("privacyAlertBtnTextColorPath"));
    }
    if (config.hasKey("privacyAlertBtnTextSize")) {
      builder.setPrivacyAlertBtnTextSize(config.getInt("privacyAlertBtnTextSize"));
    }
    if (config.hasKey("privacyAlertBtnWidth")) {
      builder.setPrivacyAlertBtnWidth(config.getInt("privacyAlertBtnWidth"));
    }
    if (config.hasKey("privacyAlertBtnHeight")) {
      builder.setPrivacyAlertBtnHeigth(config.getInt("privacyAlertBtnHeight"));
    }
    if (config.hasKey("privacyAlertCloseBtnShow")) {
      builder.setPrivacyAlertCloseBtnShow(config.getBoolean("privacyAlertCloseBtnShow"));
    }
    if (config.hasKey("privacyAlertCloseImagPath")) {
      builder.setPrivacyAlertCloseImagPath(config.getString("privacyAlertCloseImagPath"));
    }
    if (config.hasKey("privacyAlertCloseImgWidth")) {
      builder.setPrivacyAlertCloseImgWidth(config.getInt("privacyAlertCloseImgWidth"));
    }
    if (config.hasKey("privacyAlertCloseImgHeight")) {
      builder.setPrivacyAlertCloseImgHeight(config.getInt("privacyAlertCloseImgHeight"));
    }
    if (config.hasKey("tapPrivacyAlertMaskCloseAlert")) {
      builder.setTapPrivacyAlertMaskCloseAlert(config.getBoolean("tapPrivacyAlertMaskCloseAlert"));
    }
  }
